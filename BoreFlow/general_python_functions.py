...
"""Miscellaneous functions for carrying out common tasks within the BoreFlow package.
"""
...
def y2s(t):
       """Converts a measurement of time from years to seconds. 
    Parameters
    ----------
    t : float
        A measurement of time in years.
    Returns
    -------
    float
        The measurement of time converted to seconds.
    """
    return t*3.15567*1e7
def s2y(t):
    """Converts a measurement of time from seconds to years. 
    Parameters
    ----------
    t : float
        A measurement of time in seconds.
    Returns
    -------
    float
        The measurement of time converted to years.
    """
    return t/3.15567/1e7
